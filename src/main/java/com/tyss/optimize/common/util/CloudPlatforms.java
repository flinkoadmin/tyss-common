...
public class CloudPlatforms {
    ...
    public static final List<String> mobile_browserStackCapabilityKeys = Arrays.asList("os_version:osVersion", "deviceName:deviceName", "platformName:platformName", "app:app");
    ...
    public static final List<String> mobile_saucelabCapabilityKeys = Arrays.asList("deviceName:deviceName", "platformName:platformName", "platformVersion:platformVersion", "app:app");
    public static final List<String> web_lambdaTestCapabilityKeys = Arrays.asList("platform:platform", "version:version");
    public static final List<String> mobile_lambdaTestCapabilityKeys = Arrays.asList("deviceName:deviceName", "platformName:platformName", "platformVersion:platformVersion", "app:app");
    ...
    public static String mobileHubUrl = "http://localhost:4723/wd/hub";
    public static String splitSymbol = "-";
    public static String BROWSERSTACK_APP_PREFIX = "bs://";
    public static String SAUCELAB_APP_PREFIX = "storage:";
}
